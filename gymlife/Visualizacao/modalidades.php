        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 order-lg-2 col-md-6 p-0">
                    <div class="ss-text">
                        <h4>Treinadores</h4>
                        <p>Nossos funcionarios são muito capacitados e estão prontos para lhe atender.</p>
                        <!--<a href="#">Explore</a>-->
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-4 col-md-6 p-0">
                    <div class="ss-text">
                        ...
                        <p>Desfrute das nossas aulas coletivas e melhore seu ritmo de vida cada vez mais.</p>
                        <!--<a href="#">Explore</a>-->
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-7 col-md-6 p-0">
                    <div class="ss-text second-row">
                        <h4>Body building</h4>
                        <p>Molde seu corpo de acordo com seus desejos e fique de bem consigo mesmo.</p>
                        <!--<a href="#">Explore</a>-->
                    </div>
                </div>
